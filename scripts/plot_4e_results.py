...
fmodel=Model(func)
params= fmodel.make_params(g1=10,f1=10,g2=10,f2=10,g3=10,f3=10)
...
print(popt)
p5 = func((x1,y1), popt[0], popt[1],popt[2],popt[3],popt[4],popt[5])
...
def plot_histogram(xpix,ypix,RA_new,DEC_new,RA_g,DEC_g,save_file_name):
    ...
    nbins = 75
    n, bins, patches = ax2.hist(RA_diff_arcsec,nbins, density=True, facecolor = 'blue', alpha = 0.3); 
    ...
    n, bins, patches = ax4.hist(DEC_diff_arcsec,nbins, density=True, facecolor = 'blue', alpha = 0.3); 
...
plot_scatter(x,y,RA_deg_all,DEC_deg_all,cor_ra,cor_dec,'plot_scatter.pdf')
plot_histogram(x,y,RA_deg_all,DEC_deg_all,cor_ra,cor_dec,'plot_histogram.pdf')
