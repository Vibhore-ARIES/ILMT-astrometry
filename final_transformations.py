...
z='../extras/gaia_epoch_corrected_final_1arcsec_no_companion.txt'
with open(z) as ip:
...
plot_astrometry(x,y,RA_deg_all,DEC_deg_all,cor_ra,cor_dec,'../plots/%s_final_plot.pdf'%(filename[0:-5]))
...
fits.writeto('../extras/%s_ast.fits'%(fitsname[:-5]),data,header,overwrite=True)
