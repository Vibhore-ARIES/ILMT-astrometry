...
with open("../extras/full_gaia_query_pm_1arcsec_no_companion.txt") as ip:
...
#corrected_radec = precess_new(ast_ra,ast_dec,(1,1,2000),(24,10,2022))
#print(corrected_radec)


with open("../extras/gaia_epoch_corrected_final_1arcsec_no_companion.txt", "w+") as d:
